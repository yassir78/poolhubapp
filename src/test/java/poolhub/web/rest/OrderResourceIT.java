...
class OrderResourceIT {
    ...
    private static final State DEFAULT_STATE = State.SHIPPED;
    private static final State UPDATED_STATE = State.PROCESSING;
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().ref(DEFAULT_REF).sum(DEFAULT_SUM).date(DEFAULT_DATE).state(DEFAULT_STATE);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().ref(UPDATED_REF).sum(UPDATED_SUM).date(UPDATED_DATE).state(UPDATED_STATE);
        return order;
    }
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getRef()).isEqualTo(DEFAULT_REF);
        assertThat(testOrder.getSum()).isEqualByComparingTo(DEFAULT_SUM);
    ...
    void getAllOrders() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.[*].sum").value(hasItem(sameNumber(DEFAULT_SUM))))
    ...
    void getOrder() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.sum").value(sameNumber(DEFAULT_SUM)))
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.ref(UPDATED_REF).sum(UPDATED_SUM).date(UPDATED_DATE).state(UPDATED_STATE);
        ...
        Order testOrder = orderList.get(orderList.size() - 1);
        assertThat(testOrder.getRef()).isEqualTo(UPDATED_REF);
        assertThat(testOrder.getSum()).isEqualByComparingTo(UPDATED_SUM);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.ref(UPDATED_REF).date(UPDATED_DATE).state(UPDATED_STATE);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.ref(UPDATED_REF).sum(UPDATED_SUM).date(UPDATED_DATE).state(UPDATED_STATE);
