...
import poolhub.security.SecurityUtils;
import poolhub.service.MailService;
import poolhub.service.UserService;
import poolhub.service.dto.AdminUserDTO;
import poolhub.service.dto.PasswordChangeDTO;
import poolhub.web.rest.exceptions.EmailAlreadyUsedException;
import poolhub.web.rest.exceptions.InvalidPasswordException;
import poolhub.web.rest.exceptions.LoginAlreadyUsedException;
...
public class AccountResource {
    ...
    public void registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        ...
        log.debug("first name : {}", managedUserVM.getFirstName());
