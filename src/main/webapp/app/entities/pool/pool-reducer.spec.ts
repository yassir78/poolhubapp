...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pool.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POOL_LIST actions', async () => {
    ...
    it('dispatches FETCH_POOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POOL actions', async () => {
      const expectedActions = [
        {
