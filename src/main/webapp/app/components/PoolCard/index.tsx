...
const PoolCard: FC<PoolCardProps> = ({pool}) => {
  ...
  return <div className="bg-white rounded-lg border border-gray-border pb-6 hover:cursor-pointer hover:opacity-50">
      ...
      <div className="px-6">
        <div className="leading-6 popping space-y-2">
          ...
          <div className="text-sm flex justify-between">
            <p className="font-thin popping text-tertiary ">
              {pool.price} € </p>
